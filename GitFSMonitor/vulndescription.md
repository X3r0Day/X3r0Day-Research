...
**Steps to reproduce:**
1. Run the provided `setup_poc.sh` script. This will create a git repo with a poisoned `.git/config`.
2. Run `git status` or open the folder in VS Code / Emacs.
